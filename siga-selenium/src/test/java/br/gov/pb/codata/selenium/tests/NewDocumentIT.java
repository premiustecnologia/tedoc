...
public class NewDocumentIT extends DriverBase {
	...
	/*
	 * //@Test public void newMemoDocument() throws Exception { String model =
	 * "MemorandoMemorando"; PBDocSeleniumController.start(); SigadocMesaVirtualPage
	 * mesaVirtualPage = new SigadocMesaVirtualPage();
	 * mesaVirtualPage.clicarCriarNovo(); PBDocNewDocumentPage newDocumentPage = new
	 * PBDocNewDocumentPage(); newDocumentPage.selectModel(model);
	 ...
	 * EditDocumentIt editDocument = new EditDocumentIt();
	 * editDocument.edit(Dictionary.FINALIZAR);
	 * editDocument.edit(Dictionary.ANEXAR); editDocument.edit(Dictionary.ASSINAR);
	 * }
	 */

	/*
	 * //@Test public void newLegalDocument() throws Exception { String model =
	 * "OfícioOfício"; PBDocSeleniumController.start(); SigadocMesaVirtualPage
	 * mesaVirtualPage = new SigadocMesaVirtualPage();
	 * mesaVirtualPage.clicarCriarNovo(); PBDocNewDocumentPage newDocumentPage = new
	 * PBDocNewDocumentPage(); newDocumentPage.selectModel(model);
	...
	/*
	 * //@Test public void newLegalDocument2() throws Exception { String model =
	 * "OfícioOfício"; PBDocSeleniumController.start(); SigadocMesaVirtualPage
	 * mesaVirtualPage = new SigadocMesaVirtualPage();
	 * mesaVirtualPage.clicarCriarNovo(); PBDocNewDocumentPage newDocumentPage = new
	 * PBDocNewDocumentPage(); newDocumentPage.selectModel(model);
	...
	public void newDocumentWindingProcess() throws Exception {
		...
		newDocumentPage.selectReceiver(Dictionary.USUARIO);
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage.fillDescriptionTextarea(
				"Texto de descricao para Processo de Arrolamento de Bens Excedentes, Inservíveis ou em Desuso");
		newDocumentPage.recordDocument();
	...
	public void newDocumentRightsConcession() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage
				.fillDescriptionTextarea("Texto de descricao para Processo de Concessão de Direitos e Benefícios");
		newDocumentPage.recordDocument();
	...
	public void newDocumentPecuniaryConcession() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage.fillDescriptionTextarea(
				"Texto de descricao para Processo de Concessão e Incorporação de Vantagens Pecuniárias");
		newDocumentPage.recordDocument();
	...
	public void newDocumentPaymentPublicBills() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage.fillDescriptionTextarea(
				"Texto de descricao para Processo de Pagamento de Contas de Utilidade Pública");
		newDocumentPage.recordDocument();
	...
	public void newDocumentPaymentOfDebt() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage.fillDescriptionTextarea(
				"Texto de descricao para Processo de Pagamento de Despesas Inscritas em Reconhecimento de Dívida");
		newDocumentPage.recordDocument();
	...
	public void newDocumentPaymentOfDaylies() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage
				.fillDescriptionTextarea("Texto de descricao para Processo de Pagamento de Diárias e Ajuda de Custo");
		newDocumentPage.recordDocument();
	...
	public void newDocumentPaymentOfVacation() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage.fillDescriptionTextarea(
				"Texto de descricao para Processo de Pagamento de Férias e Licença-Prêmio em Pecúnia");
		newDocumentPage.recordDocument();
	...
	public void newDocumentPaymentOfTaxes() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage.fillDescriptionTextarea(
				"Texto de descricao para Processo de Pagamento de Impostos, Taxas e Tarifas Bancárias");
		newDocumentPage.recordDocument();
	...
	public void newDocumentOfFowardAccount() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage
				.fillDescriptionTextarea("Texto de descricao para Processo de Prestação de Contas de Adiantamento");
		newDocumentPage.recordDocument();
	...
	public void newDocumentPaymentoOfSalary() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage
				.fillDescriptionTextarea("Texto de descricao para Processo para Pagamento de Pessoal e Reflexos");
		newDocumentPage.recordDocument();
	...
	public void newDocumentComission() throws Exception {
		...
		newDocumentPage.informReceiver(usuario2);
		newDocumentPage.fillDescriptionTextarea(
				"Texto de descricao para Processo Relativo aos Trabalhos de Comissão Permanente ou Especial de Licitação");
		newDocumentPage.recordDocument();
