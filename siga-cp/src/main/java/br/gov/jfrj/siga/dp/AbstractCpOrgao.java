...
@NamedQueries({
		...
		@NamedQuery(name = "consultarQuantidadeCpOrgao", query = "select count(org) from CpOrgao org where ((upper(org.nmOrgaoAI) like upper('%' || :nome || '%')) or (upper(org.siglaOrgao) like upper('%' || :nome || '%'))) and org.ativo='S'"),
