			...
			<div class="card-body">
				...
				<form name="frm" id="frm" action="gravar" method="post">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								<input type="submit" name="ok" value="<fmt:message key="botao.gravar"/>"
									class="btn btn-primary" /> <input
									type="button" value="<fmt:message key="botao.desativar"/>" class="btn btn-danger"
									onclick="location.href='desativar?id=${id}'" /> <input
									type="button" value="<fmt:message key="botao.cancela"/>"
									onclick="javascript:history.back();" class="btn btn-secondary" />
							</div>
						</div>
					</div>
				</form>
