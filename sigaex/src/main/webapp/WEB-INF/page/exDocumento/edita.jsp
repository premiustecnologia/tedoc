						...
						<div class="form-group">
							...
							<c:choose>
								<c:when test='${exDocumentoDTO.tipoDestinatario == 1}'>
									...
									<label>&nbsp;&nbsp;&nbsp;</label>
									<siga:selecao propriedade="destinatario" paramList="buscarApenasUsuariosVisiveisParaTramitacao=true" inputName="exDocumentoDTO.destinatario" tema="simple" idAjax="destinatario1" reler="ajax" modulo="siga" />
										<!--  idAjax="destinatario"  -->
								</c:when>
