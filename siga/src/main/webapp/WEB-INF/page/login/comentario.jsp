...
<div class="d-none d-md-block">
	...
	<c:if test="${f:resource('/siga.base.url') == 'http://siga.jfrj.jus.br' or f:resource('/siga.base.url') == 'https://siga.jfrj.jus.br' }">
		...
		<p style="font-size: 150%">Agora o TEdoc oferece a possibilidade de assinar documento com senha (sem token). Para isto, basta clicar na opção "Com Senha" na página de assinatura, e entrar com sua matrícula e a senha do Siga.</p>
	...
	<hr/>
	<p style="font-size: 150%">Recomendamos o navegador Google Chrome para acesso ao TEdoc.</p> </br>
	<a href="https://github.com/projeto-siga/siga" target="_blank" >Sobre o TEdoc</a>
	<hr/>
