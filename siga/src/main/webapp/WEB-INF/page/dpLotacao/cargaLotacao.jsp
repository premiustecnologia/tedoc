		...
		<div class="card bg-light mb-3" >
			...
			<form action="carga" method="post" enctype="multipart/form-data" class="form">
				...
				<div class="row">
					<div class="col-sm">
						<div class="form-group">
							<button type="submit" onclick="javascript: return validaSelecaoAnexo( this.form );" name="sbmt" class="btn btn-primary" ><fmt:message key="botao.carregar"/></button>
							<button type="button" onclick="javascript:location.href='/siga/app/lotacao/editar';" class="btn btn-danger" ><fmt:message key="botao.cancela"/></button>
						</div>
					</div>
				</div>								
			</form>			
